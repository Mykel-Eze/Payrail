        ...
        <div class="row">
            <div class="container">                    
                        ...
                        <ul class="footer-links-li social-footer-links">
                            ...
                            <li class="business-stuff">
                                <a href="https://twitter.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="../assets/images/twitter-orange.svg" alt="twitter" class="hover-scale" />
                                </a>
                                <a href="https://whatsapp.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="../assets/images/whatsapp-orange.svg" alt="whatsapp" class="hover-scale" />
                                </a>
                                <a href="https://facebook.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="../assets/images/facebook-orange.svg" alt="facebook" class="hover-scale" />
                                </a>
                        ...
                        <ul class="footer-links-li social-footer-links">
                            ...
                            <li class="footer-appstore-wrapper business-stuff">
                                <button class="app-store hover-scale">
                                    <img src="../assets/images/playstore-orange.svg" alt="google store" />
                                </button>

                                <button class="app-store hover-scale">
                                    <img src="../assets/images/appstore-orange.svg" alt="apple store" />
                                </button>

                                <button class="app-store hover-scale">
                                    <img src="../assets/images/web-orange.svg" alt="web browser" />
                                </button>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col s12 pad0-xs footer-hr-div">
                    <hr />
                    <img src="../assets/images/bizness-angala.png" alt="Payrail and Angala" class="payrail-anagala n-img-1" />
                    <img src="../assets/images/bizness-angala-white.png" alt="Payrail and Angala" class="payrail-anagala n-img-2" />
                    <hr />
                </div>

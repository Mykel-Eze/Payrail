        ...
        <div class="row">
            <div class="container">                    
                ...
                <div class="col s12 pad0-xs* f-links-wrapper flw-2">
                    <div class="ddf sa-ddf">
                        ...
                        <ul class="footer-links-li social-footer-links">
                            ...
                            <li class="business-stuff">
                                <a href="https://twitter.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/twitter-orange.svg" alt="twitter" class="hover-scale" />
                                </a>
                                <a href="https://whatsapp.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/whatsapp-orange.svg" alt="whatsapp" class="hover-scale" />
                                </a>
                                <a href="https://facebook.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/facebook-orange.svg" alt="facebook" class="hover-scale" />
                                </a>
                                <a href="https://linkedin.com/company/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/linkedin-orange.svg" alt="linkedin" class="hover-scale" />
                                </a>
                                <a href="https://instagram.com/" target="_blank" rel="noreferrer" class="social-link">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/instagram-orange.svg" alt="instagram" class="hover-scale" />
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="ddf">
                        <ul class="footer-links-li social-footer-links">
                            ...
                            <li class="footer-appstore-wrapper business-stuff">
                                <button class="app-store hover-scale">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/playstore-orange.svg" alt="google store" />
                                </button>

                                <button class="app-store hover-scale">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/appstore-orange.svg" alt="apple store" />
                                </button>

                                <button class="app-store hover-scale">
                                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/web-orange.svg" alt="web browser" />
                                </button>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col s12 pad0-xs footer-hr-div">
                    <hr />
                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/bizness-angala.png" alt="Payrail and Angala" class="payrail-anagala n-img-1" />
                    <img src="https://websites-images-1.s3.us-east-2.amazonaws.com/payrail-images/images/bizness-angala-white.png" alt="Payrail and Angala" class="payrail-anagala n-img-2" />
                    <hr />
                </div>

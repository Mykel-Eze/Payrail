            ...
            <div class="container">
                <div class="nav-wrapper">
                    <router-link to="/" class="brand-logo" @click="scrollToTop()">
                        <img src="../assets/images/business-logo-black.svg" alt="Payrail Urban" class="logo n-img-1" />
                        <img src="../assets/images/business-logo-white.svg" alt="Payrail Urban" class="logo n-img-2" />
                    </router-link>
                    ...
                    <ul id="nav-mobile-2" class="right hide-on-med-and-down ul-nav">
                        ...
                        <li>
                            <button class="nav-pry-btn black-bg btn pointer">
                                Get Started
                                <img src="../assets/images/right-chevron-white.svg" alt="right-chevron" class="right-chevron" />
                            </button>
                        </li>
                    </ul>
        ...
        <ul id="slide-out-2" class="sidenav">
            <div class="close-sidenav-div">
                <button class="sidenav-close">
                    ...
                    <img src="../assets/images/close-orange.svg" alt="close side-nav" class="n-img-2" />
                </button>
            </div>
            ...
            <div class="appstore-container-mobile andriod-device">
                <a class="download-link playstore-link" href="/" target="_blank" rel="noopener noreferrer">
                    <img src="../assets/images/playstore-mobile-black3.svg" alt="playstore" class="download-link-img n-img-1" />
                    <img src="../assets/images/playstore-mobile-white3.svg" alt="playstore" class="download-link-img n-img-2" />
                </a>
            </div>
            <div class="appstore-container-mobile ios-device">
                <a class="download-link appstore-link" href="/" target="_blank" rel="noopener noreferrer">
                    <img src="../assets/images/appstore-mobile-black3.svg" alt="appstore" class="download-link-img n-img-1" />
                    <img src="../assets/images/appstore-mobile-white3.svg" alt="appstore" class="download-link-img n-img-2" />
                </a>
            </div>
        </ul>
    </div>
